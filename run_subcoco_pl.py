...
img_sz=128
frcnn_model = run_training(stats, img_dir, img_sz=img_sz, bs=2, acc=2, workers=2, head_runs=1, full_runs=1)
model_save_path = f"models/FRCNN-subcoco-{img_sz}-final.saved"
