...
__all__ = ['fetch_data', 'fetch_subcoco', 'CocoDatasetStats', 'empty_list', 'load_stats', 'box_within_bounds',
           'SubCocoParser', 'SaveModelDupBestCallback', 'is_notebook', 'overlay_img_bbox', 'bbox_to_rect',
           'label_for_bbox', 'SubCocoDataset', 'TargetResize', 'SubCocoDataModule', 'SubCocoWrapper', 'iou_calc',
           'match_true_false_neg', 'calc_wavg_F1', 'FRCNN', 'digest_pred']
...
class SaveModelDupBestCallback(SaveModelCallback):
    ...
    def after_epoch(self):
        ...
        if self.new_best or self.epoch==0:
            ...
            backup_stem = f'{saved_stem}@{self.epoch}_{self.monitor}={self.best:.3f}'
